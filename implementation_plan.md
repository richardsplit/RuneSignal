...
| Cross-cutting | RBAC, SDK, idempotency | ✅ Complete | ~100% |
...
### CT-2 — RBAC (Compliance vs Engineering vs Auditor) ✅ COMPLETE (April 19, 2026)
**Files to create:**
...
| CT-2 | Role-based access control for compliance routes | Cross | ✅ Done — `lib/auth/roles.ts`, `GET /api/v1/auth/me`, Sidebar role badge, Migration 053, middleware route guards (`ENABLE_RBAC`) |
