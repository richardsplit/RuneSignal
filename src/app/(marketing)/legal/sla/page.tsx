    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '1.5rem', fontSize: '0.875rem', color: 'var(--text-tertiary)' }}>
          ...
          <a href="/legal/sla" style={{ color: 'var(--success)', textDecoration: 'none', fontWeight: 600 }}>SLA</a>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
          ...
          <Section title="1. Uptime Commitment">
            ...
            <p><strong>Uptime</strong> is calculated as: <code style={{ background: 'rgba(255,255,255,0.05)', padding: '0.1rem 0.4rem', borderRadius: 'var(--radius-xs)' }}>(total minutes − downtime minutes) / total minutes × 100</code></p>
          ...
          <Section title="2. Incident Severity and Response Times">
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem', marginTop: '0.5rem' }}>
              ...
              <tbody>
                <Tr>
                  <Td><span style={{ color: 'var(--danger)', fontWeight: 600 }}>P1 — Critical</span></Td>
                  <Td>Complete API unavailability; data integrity breach; security incident</Td>
                  <Td>15 minutes</Td>
                  <Td>4 hours</Td>
                </Tr>
                <Tr>
                  <Td><span style={{ color: 'var(--warning)', fontWeight: 600 }}>P2 — High</span></Td>
                  <Td>Core API degraded (&gt; 10% error rate); dashboard inaccessible; evidence export failing</Td>
                  <Td>1 hour</Td>
                  <Td>8 hours</Td>
                </Tr>
                <Tr>
                  <Td><span style={{ color: 'var(--info)', fontWeight: 600 }}>P3 — Medium</span></Td>
                  <Td>Non-critical feature degraded; webhook delivery delayed; dashboard slowness</Td>
                  <Td>4 hours</Td>
                  <Td>2 business days</Td>
                </Tr>
                <Tr>
                  <Td><span style={{ color: 'var(--text-tertiary)', fontWeight: 600 }}>P4 — Low</span></Td>
          ...
          <Section title="3. Support Channels by Tier">
            ...
            <p>Support email: <a href="mailto:support@runesignal.ai" style={{ color: 'var(--success)' }}>support@runesignal.ai</a> (monitored Mon–Fri, 09:00–18:00 UTC).</p>
          </Section>
          ...
          <Section title="4. Service Credits">
            ...
            <p>Credits must be requested within 30 days of the incident by emailing <a href="mailto:support@runesignal.ai" style={{ color: 'var(--success)' }}>support@runesignal.ai</a> with reference to the incident. Credits are the sole and exclusive remedy for uptime failures.</p>
          </Section>
          ...
          <Section title="6. Monitoring and Status">
            <p>RuneSignal maintains a public status page at <a href="https://status.runesignal.ai" style={{ color: 'var(--success)' }}>status.runesignal.ai</a> with real-time uptime data, incident history, and scheduled maintenance announcements.</p>
          ...
          <Section title="8. Contact">
            <p>SLA and support enquiries: <a href="mailto:support@runesignal.ai" style={{ color: 'var(--success)' }}>support@runesignal.ai</a></p>
            <p>Security incidents: <a href="mailto:security@runesignal.ai" style={{ color: 'var(--success)' }}>security@runesignal.ai</a></p>
          </Section>
        ...
        <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', justifyContent: 'space-between', fontSize: '0.8rem', color: 'var(--text-tertiary)' }}>
          ...
          <a href="/legal/dpa" style={{ color: 'var(--success)', textDecoration: 'none' }}>← Data Processing Agreement</a>
        </div>
      </div>
    </div>
  );
...
function Td({ children }: { children: React.ReactNode }) {
  return <td style={{ padding: '0.5rem 0.75rem', color: 'var(--text-secondary)', verticalAlign: 'top' }}>{children}</td>;
}
