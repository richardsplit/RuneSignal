        ...
        <table className="data-table">
          ...
          <tbody>
            {loading ? (
              ...
              return (
                <tr key={entry.request_id} style={{
                  background: !approved ? 'rgba(251,191,36,0.02)' : undefined,
                }}>
                  <td>
                  ...
                  <td>
                    ...
                    <div style={{ fontSize: '0.6875rem', color: 'var(--text-muted)', marginTop: '1px' }}>{provider}</div>
                  </td>
                  <td>
                    <span
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '0.3rem', flexWrap: 'wrap' }}>
                      ...
                      {tags.length > 2 && <span style={{ fontSize: '0.6875rem', color: 'var(--text-muted)' }}>+{tags.length - 2}</span>}
                    </div>
                  </td>
                  <td><span className="mono" style={{ fontSize: '0.6875rem', color: 'var(--text-muted)' }}>{output_hash}</span></td>
                  <td>
                    <span className={approved ? 'badge badge-success' : 'badge badge-warning'}>
                      {approved ? '✓ Valid' : '! Anomaly'}
                    </span>
                  </td>
                  <td style={{ color: 'var(--text-muted)', fontSize: '0.8125rem', whiteSpace: 'nowrap' }}>{relativeTime(timestamp)}</td>
