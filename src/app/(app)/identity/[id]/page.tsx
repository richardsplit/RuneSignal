...
const SOURCE_META: Record<AgentTimelineEvent['source'], { label: string; color: string; icon: string }> = {
...
function eventTitle(event: AgentTimelineEvent): string {
  const e = event.event;
...
function eventHref(event: AgentTimelineEvent): string | null {
